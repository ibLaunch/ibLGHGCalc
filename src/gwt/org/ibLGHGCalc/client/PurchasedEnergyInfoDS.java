 ...
 */
public class PurchasedEnergyInfoDS extends RestDataSource {
  private static PurchasedEnergyInfoDS instance;

  public static PurchasedEnergyInfoDS getInstance() {
    if (instance == null) {
      instance = new PurchasedEnergyInfoDS();
    }
    return instance;
  }

  private PurchasedEnergyInfoDS() {
    //set id + general stuff
    setID("purchasedEnergyInfoDS");
    setClientOnly(false);
    //setup fields
    ...
    setFields(idField, organizationIdField, sourceDescriptionField, supplierNameField, supplierContactField, 
                activityType, fuelType, energyType, supplierRegionCountry,
                ...
                transAndDistLossRate, flag_transAndDistDataType,
