 ...
 */
public class WasteGeneratedInOperationsInfoDS_1 extends RestDataSource {
  private static WasteGeneratedInOperationsInfoDS_1 instance;

  public static WasteGeneratedInOperationsInfoDS_1 getInstance() {
    if (instance == null) {
      instance = new WasteGeneratedInOperationsInfoDS_1();
    }
    return instance;
  }

  private WasteGeneratedInOperationsInfoDS_1() {
    //set id + general stuff
    setID("wasteGeneratedInOperationsInfoDS_1");
    setClientOnly(false);
    //setup fields
    ...
    IblDataSourceFloatField EF_WasteTypeAndWasteTreatment = new IblDataSourceFloatField("EF_WasteTypeAndWasteTreatment", "Waste Type And Waste Treatment Emission Factor");
    DataSourceTextField EF_WasteTypeAndWasteTreatment_Unit = new DataSourceTextField("EF_WasteTypeAndWasteTreatment_Unit", "Unit");
    ...
    setFields(idField, organizationIdField, sourceDescriptionField, 
                ...
                EF_WasteTypeAndWasteTreatment,EF_WasteTypeAndWasteTreatment_Unit,
