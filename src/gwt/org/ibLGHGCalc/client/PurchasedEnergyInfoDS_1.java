 ...
 */
public class PurchasedEnergyInfoDS_1 extends RestDataSource {
  private static PurchasedEnergyInfoDS_1 instance;

  public static PurchasedEnergyInfoDS_1 getInstance() {
    if (instance == null) {
      instance = new PurchasedEnergyInfoDS_1();
    }
    return instance;
  }

  private PurchasedEnergyInfoDS_1() {
    //set id + general stuff
    setID("purchasedEnergyInfoDS_1");
    setClientOnly(false);
    //setup fields
    ...
    IblDataSourceFloatField energyPurchased = new IblDataSourceFloatField("energyPurchased", "Fuel Purchased");
...
*/    
    ...
    setFields(idField, organizationIdField, sourceDescriptionField, supplierNameField, supplierContactField, 
                activityType, fuelType, supplierRegionCountry,
