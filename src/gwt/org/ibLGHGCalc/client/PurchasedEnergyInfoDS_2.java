 ...
 */
public class PurchasedEnergyInfoDS_2 extends RestDataSource {
  private static PurchasedEnergyInfoDS_2 instance;

  public static PurchasedEnergyInfoDS_2 getInstance() {
    if (instance == null) {
      instance = new PurchasedEnergyInfoDS_2();
    }
    return instance;
  }

  private PurchasedEnergyInfoDS_2() {
    //set id + general stuff
    setID("purchasedEnergyInfoDS_2");
    setClientOnly(false);
    //setup fields
