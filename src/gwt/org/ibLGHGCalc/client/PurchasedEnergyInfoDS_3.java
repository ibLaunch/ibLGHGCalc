 ...
 */
public class PurchasedEnergyInfoDS_3 extends RestDataSource {
  private static PurchasedEnergyInfoDS_3 instance;

  public static PurchasedEnergyInfoDS_3 getInstance() {
    if (instance == null) {
      instance = new PurchasedEnergyInfoDS_3();
    }
    return instance;
  }

  private PurchasedEnergyInfoDS_3() {
    //set id + general stuff
    setID("purchasedEnergyInfoDS_3");
    setClientOnly(false);
    //setup fields
...
*/
    ...
    DataSourceTextField transAndDistDataType = new DataSourceTextField("transAndDistDataType", "Data Type(Energy or Scope2)");
    ...
    setFields(idField, organizationIdField, sourceDescriptionField, supplierNameField, supplierContactField, 
                ...
                transAndDistLossRate, transAndDistDataType,
                scope2EmissionsOfEnergyUse, scope2EmissionsOfEnergyUse_Unit,                        
